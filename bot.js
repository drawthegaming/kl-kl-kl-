...
.setTitle('Ben Eternal Hizmetinizdeyim')
kanal.send(embed)
...
let i = ayarlar.sahip
          if (msg.author.id == 471633704200962068) {
...
db.set(`goldzzz_${msg.author.id}`, Date.now());
  ...
  .setDescription(`<a:memocuk:793442237370466324> İşte Eternal botun sahibi <@${msg.author.id}> geldi!`)
  .setColor("BLACK")
